...
# RSpec.shared_examples 'my custom examples' do |_vigia_example, response|
#   if (200..201).include?(described_class.response.name.to_i)
...
#     end
#   elsif described_class.response.name.to_i == 204
#     it 'body is nil' do
...
# RSpec.shared_examples 'scenarios resource examples' do |_vigia_example, response|
#   before do
...
# RSpec.shared_examples 'scenarios get index action examples' do |_vigia_example, response|
#   before do
#     @json_result = JSON.parse(result[:body])
#   end
